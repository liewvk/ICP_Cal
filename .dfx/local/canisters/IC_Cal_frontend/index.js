...
import { idlFactory } from './IC_Cal_frontend.did.js';
export { idlFactory } from './IC_Cal_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IC_CAL_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./IC_Cal_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the IC_Cal_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./IC_Cal_frontend.did.js")._SERVICE>}
 */
export const IC_Cal_frontend = createActor(canisterId);
